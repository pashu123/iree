...
getTiledAndDistributionInfo(RewriterBase &rewriter,
  ...
  // TODO: It is expected that at most one compute op has a workgroup tiling level.
  // Currently, it selects the last compute op that has a workgroup tiling level.
